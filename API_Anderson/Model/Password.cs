...
namespace API_Ejemplo.Model
{
    public class Password
    {
        ...
        private static int MINIMA_LONGITUD_POR_DEFECTO = 8;
        private static int MAXIMA_LONGITUD_POR_DEFECTO = 10;
        ...
        private static string PASS_CHARS_ESPECIALES = "._-@#$%&!*?";
        ...
        private string Generate(int minLength,
                                      int maxLength)
        {
            ...
            char[][] Chars_Grupos = new char[][]
        {
            ...
            PASS_CHARS_ESPECIALES.ToCharArray()
        };
