...
class App9 extends Component {
    ...
    componentDidMount() {
        axios.get(`https://localhost:44357/api/Reporte/ObtenerIncidenteContinenSem`)
            .then(res => {
            ...
            <div>
                <ul>
                    <HighchartsChart plotOptions={plotOptions}>
                        <Chart type="column" />
                        <Title>Promedio de tiempo en continencia de las incidencias desde el descubrimiento semanalmente</Title>
...
export default withHighcharts(App9, Highcharts);