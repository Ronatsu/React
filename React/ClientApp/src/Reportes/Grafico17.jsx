...
class App16 extends Component {
    ...
    componentDidMount() {
        axios.get(`https://localhost:44357/api/Reporte/ObtenerIncidenteHorTrim`)
            .then(res => {
            ...
            <div>
                <ul>
                    <HighchartsChart plotOptions={plotOptions}>
                        <Chart type="column" />
                        <Title>Horas incidentes trimestre</Title>
...
export default withHighcharts(App16, Highcharts);