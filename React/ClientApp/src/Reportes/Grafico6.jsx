...
class App4 extends Component {
    ...
    componentDidMount() {
        axios.get(`https://localhost:44357/api/Reporte/ObtenerIncidenteTiemContAnno`)
            .then(res => {
            ...
            <div>
                <ul>
                    <HighchartsChart plotOptions={plotOptions}>
                        <Chart type="column" />
                        <Title>Promedio de tiempo en continencia de las incidencias desde el descubrimiento anualmente</Title>
...
export default withHighcharts(App4, Highcharts);