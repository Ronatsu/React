...
class App8 extends Component {
    ...
    componentDidMount() {
        axios.get(`https://localhost:44357/api/Reporte/ObtenerIncidenteInterSem`)
            .then(res => {
            ...
            <div>
                <ul>
                    <HighchartsChart plotOptions={plotOptions}>
                        <Chart type="column" />
                        <Title>Incidentes detectados de manera interna semanualmente</Title>
...
export default withHighcharts(App8, Highcharts);